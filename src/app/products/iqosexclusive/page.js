...
export async function generateMetadata() {
  ...
  const pageUrl = `https://${domain}/products/iqosexclusive`;
  ...
  return {
    ...
    openGraph: {
      title:
        "Купить лимитированные устройства IQOS ILUMA в IqosSticks с доставкой по России",
      description:
  ...
  return (
    <div className="products-container">
      <h1 className="page-title" style={{ marginBottom: "2rem" }}>
        Лимитированные устройства IQOS ILUMA
      </h1>
