...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://iqossticks.ru/${article.slug}`,
    },
    openGraph: {
      title: article.title,
      description: article.metaDescription || article.description,
      url: `https://iqossticks.ru/${article.slug}`,
      type: "article",
...
export default function ArticlePage({ params }) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Блог",
        item: "https://iqossticks.ru",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: article.title,
        item: `https://iqossticks.ru/${article.slug}`,
      },
    ],
  };
  ...
  const articleSchema = {
    ...
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://iqossticks.ru/${article.slug}`,
    },
  };
