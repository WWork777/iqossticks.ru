...
export async function POST(req) {
  try {
    ...
    let subject = "Заявка с сайта iqossticks.ru";
    ...
    if (text.includes('НОВЫЙ КЛИЕНТ') || text.includes('🔥 НОВЫЙ КЛИЕНТ 🔥')) {
      subject = `🔥 НОВЫЙ КЛИЕНТ: ${customerName} - iqossticks.ru`;
    } else {
      subject = `Заявка от ${customerName} - iqossticks.ru`;
    }
        ...
        <body>
          <div class="email-container">
            <div class="email-header">
              <h2>Заявка с сайта iqossticks.ru</h2>
            </div>
            ...
            <div class="email-content">
              ...
              <div class="footer">
                <p>Отправлено с сайта iqossticks.ru</p>
