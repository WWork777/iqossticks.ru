...
export async function GET() {
  ...
  const subdomains = [
    'msk', 'moscow', 'spb', 'ekb', 'kazan', 'nn', 
    'chelyabinsk', 'samara', 'omsk', 'rostov', 'ufa',
    'krasnoyarsk', 'perm', 'voronezh', 'volgograd',
    'krasnodar', 'novosibirsk', 'nsk', 'khabarovsk',
    'vladivostok', 'irkutsk', 'kemerovo', 'krym', 'donetsk', 'dnr', 'kaliningrad'
  ];
